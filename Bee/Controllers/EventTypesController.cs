...
namespace Bee.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventTypeId,Name,Desc")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventTypeId,Name,Desc")] EventType eventType)
        {
