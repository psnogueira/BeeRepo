...
{
    public class CompanyDetail : ICompany
    {
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;

        public CompanyDetail(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
            this._configuration = configuration;
            this._webHostEnvironment = webHostEnvironment;
        }

        public DataTable CompanyDataTable(string path)
        {
        ...
        public void ImportCompany(DataTable company)
        {
            ...
            using (SqlConnection sCon = new SqlConnection(sqlConn))
            {
                ...
                {
                    sqlBulkCopy.DestinationTableName = "Company";
                    ...
                    sqlBulkCopy.WriteToServer(company);
                    sCon.Close();
                }
            }
